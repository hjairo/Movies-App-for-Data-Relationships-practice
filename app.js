  ...
  try {
    ...
    const movieInstances = await Promise.all([
      Movie.create({
        ...
        releaseYear: 1999,
        directorPersonId: bradBird.id, // This happens bc of the association made in movie.js
      }),
      Movie.create({
    ...
    const movies = await Movie.findAll({
      include: [ // Includes the Person's name so that it is displayed when referenced
        {
          model: Person,
          as: 'director',
        },
